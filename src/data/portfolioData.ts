...
export const personalInfo: PersonalInfo = {
  ...
  heroSubheadline: "Full Stack Developer building modern web applications with Next.js & TypeScript.",
...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: ["Git", "GitHub", "Bitbucket", "Postman", "Vercel", "AWS EC2", "cPanel"]
  },
  {
    title: "Other",
    skills: ["REST APIs", "JWT Authentication", "Razorpay", "Redux", "Headless WordPress", "CMS Integration"]
  }
];
...
export const experienceData: ExperienceItem[] = [
  {
    ...
    techUsed: ["Next.js", "TypeScript", "Node.js", "Express.js", "Laravel", "MongoDB", "MySQL", "Tailwind CSS", "AWS EC2", "Vercel"]
  }
];
...
export const projectsData: ProjectItem[] = [
  {
    ...
    isFeatured: true,
    badgeText: "Featured Personal Project",
    description: "Full-stack property rental management platform built with Next.js, TypeScript, MongoDB, and Mongoose. Includes property discovery, advanced filtering, authentication, favorites, booking workflows, and an admin management dashboard.",
    tech: ["Next.js", "TypeScript", "MongoDB", "Mongoose", "Tailwind CSS", "Zod", "React Hook Form", "Recharts", "JWT"],
    features: [
  ...
  },
  {
    ...
    description: "Production logistics and driver recruitment platform built with Next.js and Headless WordPress. Includes dynamic CMS-driven content and a multi-step driver application workflow.",
    tech: ["Next.js", "TypeScript", "Headless WordPress", "MongoDB", "Tailwind CSS", "AWS EC2"],
    features: [
    ...
    image: "/projects/sigma-transport.jpg"
  },
  {
    ...
    type: "Professional Project",
    badgeText: "Professional Project",
    description: "Next.js e-commerce platform featuring product catalog, shopping cart, secure checkout, Razorpay payment integration, and an admin dashboard for product and order management.",
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "Express.js", "MongoDB", "Razorpay"],
    features: [
      "Product catalog",
      "Shopping cart",
      "Secure checkout",
    ...
    image: "/projects/amirthan-oil-mills.jpg"
  },
  {
    id: "cinqcare",
    ...
    description: "CMS-driven healthcare web portals developed using Next.js and Headless WordPress with responsive Tailwind CSS components and Vercel deployment.",
...
export const whatIBuildHighlights: HighlightItem[] = [
  {
    ...
    description: "Responsive and reusable interfaces using Next.js, React, TypeScript and Tailwind CSS.",
    icon: "Layout"
  },
  {
    title: "Backend & APIs",
    description: "REST APIs, authentication, database integration and server-side functionality.",
    icon: "Server"
  },
  {
    title: "E-commerce",
    description: "Product management, carts, orders, checkout and Razorpay payment integration.",
    icon: "ShoppingCart"
  },
  {
    title: "CMS & Production",
    description: "Headless WordPress integration and deployment using AWS EC2 and Vercel.",
    icon: "Globe"
  }
];
...
export const whyWorkWithMePoints: ValueItem[] = [
  {
    ...
    description: "I focus on reusable components, clear architecture and maintainable code."
  },
  {
  ...
  },
  {
    ...
    description: "I have worked on real applications across logistics, healthcare and e-commerce."
  },
  {
...
export const educationInfo: EducationItem = {
  ...
  period: "2022 – 2025",
  grade: "CGPA: 8/10",
  specialMention: "Class 12 Computer Science — 100/100"
};
